...
def get_parser():
    ...
    parser.add_argument(
        '--work-dir' ,
        default='./work_dir/2101',
        help='the work folder for storing results')

    parser.add_argument('-model_saved_name', default='./runs/2101')
    parser.add_argument(
        '--config',
        default='./config/uav-cross-subjectv1/test.yaml',
    ...
    # visulize and debug
    parser.add_argument(
        '--seed', type=int, default=777, help='random seed for pytorch')
    parser.add_argument(
        '--log-interval',
        type=int,
        default=100,
    ...
    parser.add_argument('--only_train_epoch', type=int,default=60)
...
class Processor():
    ...
    def load_model(self):
        if isinstance(self.arg.device, list):
            ...
            # 检查是否所有的设备 ID 都在有效范围内

            self.arg.device = [available_gpus[0]]
